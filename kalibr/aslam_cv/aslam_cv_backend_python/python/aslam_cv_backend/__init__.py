# Catkin's install environment already exposes these modules through
# PYTHONPATH.  Import them directly so the bindings also work in a ROS-free
# Apollo runtime where roslib is intentionally not installed.
import numpy_eigen
import sm
